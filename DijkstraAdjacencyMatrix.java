...
public class DijkstraAdjacencyMatrix {
    ...
    static class Graph{
        ...
        public void printDijkstra2(int sourceVertex, int destinationVertex, int [] key){
            System.out.println("Dijkstra Algorithm: (Adjacency Matrix)");
            System.out.println("Source Vertex: " + sourceVertex + " to vertex " +   + destinationVertex +
                        " distance: " + key[destinationVertex]);
            }
    }
    ...
    public static void main(String[] args) {
        ...
        graph.dijkstra_GetMinDistances(sourceVertex);
        //graph.printDijkstra2(sourceVertex, destinationVertex, 10);
    }
}